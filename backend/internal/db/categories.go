...
func (s *PostgresStore) CreateCategory(parentCtx context.Context, category *models.Category) error {
...
func (s *PostgresStore) GetCategories(parentCtx context.Context) ([]*models.Category, error) {
	ctx, cancel := context.WithTimeout(parentCtx, time.Second*3)
	defer cancel()
...
func (s *PostgresStore) GetCategoryByID(parentCtx context.Context, id int) (*models.Category, error) {
	ctx, cancel := context.WithTimeout(parentCtx, time.Second*3)
	defer cancel()
...
func (s *PostgresStore) UpdateCategory(parentCtx context.Context, category *models.Category) error {
	ctx, cancel := context.WithTimeout(parentCtx, time.Second*3)
	defer cancel()
